...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class GoogleApiServicesLibraryAccessors extends SubDependencyFactory {
        private final GoogleApiServicesDriveLibraryAccessors laccForGoogleApiServicesDriveLibraryAccessors = new GoogleApiServicesDriveLibraryAccessors(owner);

        public GoogleApiServicesLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>google.api.services.drive</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public GoogleApiServicesDriveLibraryAccessors getDrive() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForGoogleApiServicesDriveLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class GoogleApiServicesDriveLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public GoogleApiServicesDriveLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        /**
         * Dependency provider for <b>vv3rev1361250</b> with <b>com.google.apis:google-api-services-drive</b> coordinates and
         ...
         */
        @Deprecated
        public Provider<MinimalExternalModuleDependency> getVv3rev1361250() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("google.api.services.drive.vv3rev1361250");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>googleApiServicesDrive</b> with value <b>v3-rev20230227-2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>googleApiServicesDriveVersion</b> with value <b>v3-rev136-1.25.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
